    ...
    private int func_177077_a(EntityItem itemIn, double p_177077_2_, double p_177077_4_, double p_177077_6_, float p_177077_8_, IBakedModel p_177077_9_)
    {
        ...
        else
        {
            ...
            if (!(item instanceof ItemBlock)){
                GlStateManager.translate((float)p_177077_2_, (float)p_177077_4_ + 0.1F, (float)p_177077_6_);
            }else {
                GlStateManager.translate((float)p_177077_2_, (float)p_177077_4_ + 0.2F, (float)p_177077_6_);
            }
